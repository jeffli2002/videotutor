...
class SceneScene(Scene):
    def construct(self):
        ...
        # 标题 - 使用较小的字体避免占用太多空间
        title = Text("生成一个三角形面积不变的拉窗帘原理的动画...", font_size=32, color=BLUE).to_edge(UP, buff=0.3)
        ...
        explanation_lines = []
        solution_text = "拉窗帘原理是三角形面积不变原理。当三角形的顶点沿着平行于底边的直线移动时，三角形的面积保持不变。"
