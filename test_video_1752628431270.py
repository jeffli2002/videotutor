...
class MathSolutionScene(Scene):
    def construct(self):
        ...
        step_content_1_0 = Text("题目要求我们求函数 f(x) = 2x + 3 在 x = 4", font_size=22, color=WHITE)
        step_content_1_0.next_to(step_title_1, DOWN, buff=0.5)
        self.play(Write(step_content_1_0))
        self.wait(0.8)
        step_content_1_1 = Text("时的值。也就是说，当输入值（自变量）为 4", font_size=22, color=WHITE)
        step_content_1_1.next_to(step_title_1, DOWN, buff=0.9)
        self.play(Write(step_content_1_1))
        self.wait(0.8)
        step_content_1_2 = Text("时，输出值（因变量）是多少。这是一个典型的函数代入求值问题。", font_size=22, color=WHITE)
        ...
        step_content_2_0 = Text("函数的表达式已经给出： f(x) = 2x + 3", font_size=22, color=WHITE)
        ...
        step_content_3_0 = Text("将 x = 4 代入函数表达式中： f(4) = 2 4 + 3", font_size=22, color=WHITE)
        step_content_3_0.next_to(step_title_3, DOWN, buff=0.5)
        self.play(Write(step_content_3_0))
        self.wait(0.8)
        step_content_3_1 = Text("先进行乘法运算： 2 4 = 8 然后进行加法运算： 8 + 3 =", font_size=22, color=WHITE)
        step_content_3_1.next_to(step_title_3, DOWN, buff=0.9)
        self.play(Write(step_content_3_1))
        self.wait(0.8)
        step_content_3_2 = Text("11", font_size=22, color=WHITE)
        ...
        self.wait(0.8)
        step_content_4_1 = Text("---", font_size=22, color=WHITE)
