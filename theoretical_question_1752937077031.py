...
class SceneScene(Scene):
    def construct(self):
        ...
        # 标题 - 使用较小的字体避免占用太多空间
        title = Text("帮我生成一个三角形面积不变的拉窗帘原理讲...", font_size=32, color=BLUE).to_edge(UP, buff=0.3)
        ...
        explanation_lines = []
        solution_text = "拉窗帘原理是几何学中的重要概念，它展示了三角形面积的不变性。当我们沿着三角形的中线剪开并重新组合时，面积保持不变。"
